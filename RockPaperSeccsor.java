        ...
        while (playAgain) {
            ...
            for (int i = 1; i <= rounds; i++) {
                ...
                if (userChoice - 1 == computerChoice) {
                    ...
                    System.out.println(GREEN + "You win this round! " + choices[userChoice - 1] + " beats "
                            + choices[computerChoice] + RESET);
                    userScore++;
                } else {

                    System.out.println(RED + "Computer wins this round! " + choices[computerChoice] + " beats "
                            + choices[userChoice - 1] + RESET);
                    computerScore++;
                }
            }
